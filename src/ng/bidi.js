 ...
 * @description
 *
 * The $bidiProvider provider allows developers to configure the {@link ng.$bidi $bidi} service.
 * -   enable/disable bidirectional text support in a module
 */
 ...
 *
 * @description
 * Provides a way to estimate the text direction of a string and to apply it to html elements
 * using the `dir` attribute as well as to html attributes using unicode control characters.
 *
...
function $BidiProvider() {
  ...
  /**
   * @ngdoc method
   * @name $bidiProvider#enabled
   * @function
   *
   * @param {boolean=} value If provided, then enables/disables bidi.
   * @return {boolean} true if bidi is enabled, false otherwise.
   *
   * @description
   * Enables/disables bidi and returns the current value.
   */
